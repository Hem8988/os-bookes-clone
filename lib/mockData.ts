...
export const INITIAL_SALE_ORDERS: SaleOrder[] = [
  {
    id: 'so-301',
    soNumber: 'SO-2026-0155',
    customerId: 'cust-1',
    customerName: 'Sharma Electronics & Superstore',
    customerPhone: '+91 98260 12345',
    customerGstin: '23AABCS1429B1Z8',
    date: '2026-07-26',
    validUntil: '2026-08-05',
    taxableAmount: 24152.54,
    totalCgst: 2173.73,
    totalSgst: 2173.73,
    totalAmount: 28500,
    status: 'Pending',
    paymentMode: 'Credit',
    remark: 'Immediate dispatch via Route 1',
    deliveryBoyId: 'staff-5',
    ...
    items: [
      ...
      },
      {
        id: 'soi-2',
        productId: 'prod-2',
        productName: 'Industrial LPG Hose Pipe (2 Meter Wire-Braided)',
        hsnCode: '40092100',
        gstRate: 18,
        quantity: 5,
        mrp: 1200,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 'soi-4',
        productId: 'prod-3',
        productName: 'Heavy-Duty Commercial High-Pressure LPG Regulator',
        hsnCode: '84818030',
        gstRate: 18,
        quantity: 2,
        mrp: 2100,
  ...
  {
    id: 'so-303',
    soNumber: 'SO-2026-0156',
    customerId: 'cust-3',
    customerName: 'Indore Grand Hotel & Banquet',
    customerPhone: '+91 94250 99887',
    customerGstin: '23AAACI5544K1ZZ',
    date: '2026-07-27',
    validUntil: '2026-08-07',
    taxableAmount: 31355.93,
    totalCgst: 2822.03,
    totalSgst: 2822.03,
    totalAmount: 37000,
    status: 'Pending',
    paymentMode: 'Credit',
    remark: 'Hotel banquet emergency refilling - awaiting driver assignment',
...
export const INITIAL_STAFF: EmployeeMaster[] = [
  ...
  },
  {
    ...
    email: 'ramesh.delivery@os-books.com',
    salary: 16000,
    commissionPercent: 0,
    active: true,
    designation: 'Commercial LPG Delivery Driver (MP-09-GF-4432)',
  },
  {
    id: 'staff-6',
    name: 'Suresh Verma',
    ...
    email: 'suresh.delivery@os-books.com',
    salary: 16000,
    commissionPercent: 0,
    active: true,
    designation: 'Bulk Delivery Driver (MP-09-AB-1234)',
  },
  {
    id: 'staff-7',
    name: 'Mukesh Yadav',
    ...
    email: 'mukesh.delivery@os-books.com',
    salary: 15000,
    commissionPercent: 0,
    active: true,
    designation: 'Route-3 Delivery Person (MP-09-TR-7890)',
  },
];
