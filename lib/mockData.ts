...
export const INITIAL_PRODUCTS: Product[] = [
  {
    id: 'prod-1',
    name: 'Wireless Barcode Scanner Handheld (2.4G Laser)',
  ...
  {
    id: 'prod-2',
    name: 'Thermal Paper Roll 80mm x 50m (Pack of 10 Rolls)',
    ...
    stock: 8,
    minStockAlert: 15,
    rackLocation: 'Shelf B-03',
  },
  {
    id: 'prod-3',
    name: 'Logitech Wireless Optical Mouse M235',
  ...
  {
    id: 'prod-4',
    name: 'Epson Thermal Receipt Printer TM-T82III (USB/LAN)',
    category: 'Barcode & Thermal Printers',
    brand: 'Epson',
    sku: 'EPS-PRT-82',
  ...
  {
    id: 'prod-5',
    name: 'Dell 24" IPS Full HD Monitor (HDMI/VGA/Borderless)',
    category: 'Monitors & Display',
    brand: 'Dell',
    sku: 'DEL-MON-24',
  ...
  {
    id: 'prod-6',
    name: 'D-Link Cat6 Ethernet Cable (305m Heavy Box)',
    ...
    stock: 2,
    minStockAlert: 5,
    rackLocation: 'Warehouse Bay 2',
  },
  {
    id: 'prod-7',
    name: 'TVS-E Heavy Duty Cash Drawer (4 Bills 8 Coins)',
    category: 'POS Hardware',
    brand: 'TVS Electronics',
    sku: 'TVS-CD-410',
  ...
  {
    id: 'prod-8',
    name: 'Zebra Desktop Barcode Label Printer ZD220',
    category: 'Barcode & Thermal Printers',
  ...
  {
    id: 'prod-9',
    name: 'Thermal Barcode Stickers 50mm x 25mm (Roll of 1000)',
    category: 'POS Consumables',
    brand: 'TVS Electronics',
    sku: 'STK-5025-1000',
